            ...
            Task.Run(() =>
            {
                ...
                while (true)
                {
                    try
                    {
                        ...
                        if (request.Url.AbsolutePath.StartsWith("/export/pdf"))
                        {
                        ...
                        else if (request.Url.AbsolutePath.StartsWith("/export/excel"))
                        {
                        ...
                        else if (request.Url.AbsolutePath.StartsWith("/export/text"))
                        {
